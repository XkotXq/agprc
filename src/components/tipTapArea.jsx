...
import { Minus, TextAlignCenter, TextAlignEnd, TextAlignStart } from 'lucide-react'
            ...
            <div className="flex gap-1 flex-wrap justify-start w-full">
                ...
                <Button size="icon"
                    ...
                    <Button
                        ...
                        variant="ghost"
                    >
                        <TextAlignStart className="w-[28px] h-[28px]"/>
                    </Button><Button
                    ...
                    variant="ghost"
                >
                    <TextAlignCenter className="w-[28px] h-[28px]"/>
                </Button>
                    <Button
                        ...
                        variant="ghost"
                    >
                        <TextAlignEnd className="w-[28px] h-[28px]"/>
                    </Button>
...
const TipTap = ({ setTextState, textState, limit=null }) => {
    const content = useMemo(() => textState || '', [textState]);
    ...
    return (
        <EditorProvider slotBefore={<MenuBar />} extensions={extensions} content={content} onUpdate={handleUpdate} immediatelyRender={false}>
            <EditorWrapper />
        </EditorProvider>
    )
}
